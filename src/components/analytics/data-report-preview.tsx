...
import {
  useDataReport,
} from "@/hooks/analytics/use-data-reports";

import type {
  AnalyticsRange,
} from "@/types/analytics-filter";

type DataReportPreviewProps = {
  storeId:
    string;
...
export function DataReportPreview({
  storeId,
  range,
  downloading,
  onDownload,
}: DataReportPreviewProps) {
  const {
    data,
    isLoading,
    isError,
      ...
      <Card className="border-border/60 shadow-sm">
        <CardContent className="flex min-h-40 flex-col items-center justify-center p-6 text-center">
          ...
          <p className="mt-3 font-medium">
            Unable to generate data report
          </p>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            A detailed summary of customer engagement for the selected period.
          </p>
        </div>
          ...
          <div className="relative">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Here&apos;s how customers engaged during the selected period.
                </p>
              </div>
        ...
        <CardContent className="space-y-6 p-5 sm:p-7">
          ...
          <div className="border-t border-border/60 pt-5 text-center">
            <p className="text-xs text-muted-foreground">
              This report is generated from your ValYou customer engagement
